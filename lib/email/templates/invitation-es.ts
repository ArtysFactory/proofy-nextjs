// ============================================
// PROOFY - Email Template: Co-signature Invitation (Spanish)
// ============================================
...
export function generateInvitationEmailHTML_ES(params: InvitationEmailParams): string {
  const expirationDate = params.expiresAt.toLocaleDateString('es-ES', {
    weekday: 'long',
    year: 'numeric',
    month: 'long',
    day: 'numeric'
...
<head>
  ...
  <title>Invitación a co-firmar - UnlmtdProof</title>
  <!--[if mso]>
  <noscript>
    <xml>
                ...
                <tr>
                  <td align="center">
                    ...
                    <p style="margin: 4px 0 0 0; font-size: 13px; color: #666666;">
                      Prueba de propiedad en blockchain
                    </p>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td class="content" style="padding: 40px;">
                    ...
                    <h2 class="title" style="margin: 0 0 16px 0; font-size: 24px; font-weight: 700; color: #ffffff; line-height: 1.3;">
                      Estás invitado/a a confirmar tu participación
                    </h2>
                    
                    <!-- Intro text -->
                    <p style="margin: 0 0 28px 0; font-size: 16px; line-height: 1.6; color: #999999;">
                      <strong style="color: #ffffff;">${params.depositorName}</strong> te invita a confirmar tu rol como titular de derechos sobre la siguiente obra. Tu firma es necesaria para finalizar el depósito en blockchain.
                    </p>
                            ...
                            <tr>
                              ...
                              <td style="padding-left: 12px;">
                                ...
                                <p style="margin: 0; font-size: 13px; color: #cc8400; line-height: 1.5;">
                                  Fecha límite: ${expirationDate}. Pasada esta fecha, el depósito será cancelado automáticamente.
                                </p>
                              </td>
                            </tr>
                          </table>
                ...
                <tr>
                  <td style="padding: 24px;">
                    ...
                    <p style="margin: 0; font-size: 13px; color: #888888; line-height: 1.6;">
                      UnlmtdProof es un servicio de depósito legal que registra la prueba de propiedad de tus creaciones en la blockchain de Polygon. 
                      Tu firma confirma tu acuerdo con la distribución de derechos declarada por el depositante.
                    </p>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td align="center" style="padding-bottom: 16px;">
                    <p style="margin: 0; font-size: 13px; color: #666666;">
                      Este correo fue enviado por <strong style="color: #888888;">UnlmtdProof</strong>
                    </p>
                    <p style="margin: 8px 0 0 0; font-size: 12px; color: #555555;">
                      Parte del ecosistema <a href="https://artys.network" style="color: #bff227;">Artys Network</a>
                    </p>
                  </td>
                </tr>
                <tr>
                  <td align="center">
                    <p style="margin: 0; font-size: 11px; color: #444444; line-height: 1.6;">
                      ...
                      © ${new Date().getFullYear()} UnlmtdProof. Todos los derechos reservados.
                    </p>
                  </td>
                </tr>
              </table>
